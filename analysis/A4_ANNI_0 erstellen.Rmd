...
input_tabelle <- data.table::fread(
    "../data/derived_data/input_tabelle_2020_2021_20220314.csv", 
    sep = ";", dec = ".") %>% as_tibble()
```
\
...
nn=neuralnet(T0060_mm ~ tage_seit_aussaat+ 
             ...
             #Tage_seit_Aussaat+T0020_nFK_Vortag+T2040_nFK_Vortag+ T4060_nFK_Vortag+Tmean+RF+Glob+RHmin+V2+wasser_input_Vortag,
