...
tensio_melted <- tidyr::pivot_longer(tensio,# %>%
    ...
    mutate(Bodentiefe = substr(Bodentiefe, 7,8) %>% as.numeric()) %>%
...
p7 <- plot_nfk(satz_nr = 7, subtitle = "2023, Satz 2, Feld 4b", wdh = FALSE, grafik = grafik) 
p8 <- plot_nfk(satz_nr = 8, subtitle = "2023, Satz 3, Feld 4a", wdh = FALSE, grafik = grafik) 
...
# 
# purrr::map2(file_list, list(#p6, p7, 
#                             p8),
